            ...
            <div class="fixed-table-pagination">
              ...
              <div class="float-right pagination">
                <ul class="pagination">
                  ...
                  <li class="page-item"><a class="page-link" aria-label="to page 3" href="#">4</a></li>
                  <li class="page-item"><a class="page-link" aria-label="to page 3" href="#">5</a></li>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card my-4">
            ...
            <div class="fixed-table-pagination">
              <div class="float-left pagination">
                <button type="button" class="btn btn-outline-success mt-2 ms-1 mb-1" id="">
